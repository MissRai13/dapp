...
event ContributionReceived(
 ...
 function createProject(
   ...
   require(minimumContribution > 0,'Minimum contribution should be greater than 0');
   require(targetContribution >= minimumContribution,'Goal should be greater than minimum contribution');
   require(deadline > block.timestamp,'Deadline should be a future timestamp');
...
function contribute(address _projectAddress) public payable{
   ...
   Project(_projectAddress).refreshState();
